...
def parse_args():
    ...
    parser.add_argument("--max_new_tokens", type=int, default=96, help="")

    # parameters related to train and evaluation
    parser.add_argument("--agent_data", type=str, default="./data/million_villagers_1024.json", help="")
...
def main(args):
    ...
    for round in range(args.num_rounds):
        ...
        with accelerator.split_between_processes(list(range(len(conversations_list))), apply_padding=True) as conversations_idx:
            ...
            if args.vlm=="llava-hf/llava-1.5-13b-hf":
                batch_size = 2
            else:
                batch_size = 8
    ...
    if accelerator.is_main_process:
        ...
        filename = "./data/{}/{}_{}_{}_{}_{}_{}_{}.csv".format(
            "train",
            args.high, 
