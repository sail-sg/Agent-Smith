...
active_thought_prompt_q = "Behave as you are {}. Please select an image from your album and explain why."
...
class Agent:
    ...
    def generate_question(self):
        ...
        state.append_message(state.roles[0], active_thought_prompt_q.format(self.agent_name))
        ...
        state.append_message(state.roles[0], active_action_prompt_q.format(self.agent_name))
        state.append_message(state.roles[1], None)
    ...
    def generate_response(self, prompt):
        ...
        state.append_message(state.roles[0], passive_action_prompt_q.format(self.agent_name, prompt))
        state.append_message(state.roles[1], None)
